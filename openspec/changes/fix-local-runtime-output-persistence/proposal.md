...
- Make User-mode `serve` startup honor a complete runtime-provided Elasticsearch output.
- Fail startup when runtime output configuration is absent or invalid instead of silently selecting stdout.
...
- Affects the ESDiag container, local Elasticsearch exporter, keystore preflight, and standalone integration coverage.
