...
- [x] 1.2 Create a `docs/` directory at the project root and populate it with an initial `documentation.md` and a nested `example/subtopic.md` containing placeholder documentation.
...
- [x] 3.4 Update the main application header template to include a "Book" button that links to `/docs/documentation`.
- [x] 3.5 Wire the Askama template to the `/docs/*path` Axum handler.

## 4. Verification

- [x] 4.1 Run the web server and verify that navigating to `/docs/documentation` successfully loads and renders the offline documentation layout.
