# Capability: Asset Security Filtering

## Purpose
The system needs to intelligently skip certain assets (like users, roles, and privileges) when the target Elasticsearch cluster does not have security features enabled. This avoids unnecessary errors and noise during the diagnostic collection process.
