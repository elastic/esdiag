...
## Purpose
The purpose of this capability is to identify and record metadata related to the orchestration platform hosting a diagnostic bundle and the relationships between parent and child diagnostics.
